...
test('number returns errors for non-numbers', () => {
  ...
  expect(number(undefined).errors).toBe('This field must be a number');
...
test('maybe(number) returns error for non-numbers', () => {
  expect(maybe(number)(null).errors).toBe('This field must be a number');
...
test('number returns errors for non integer', () => {
  ...
  expect(int(undefined).errors).toBe('This field must be an integer');
